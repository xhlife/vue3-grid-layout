...
interface TranFormStyleInfo {
  transform?: string | undefined;
  WebkitTransform?: string | undefined;
  MozTransform?: string | undefined;
 ...
 * @returns {string}
 */
export function createMarkup(obj: any): any {
 ...
 * @returns {*}
 */
export function addPx(name: string, value: number | string): number | string {
...
export function findItemInArray(array: any, property: string, value: any): boolean {
  for (let i = 0; i < array.length; i++) if (array[i][property] === value) return true;

  return false;
}

export function findAndRemove(array: any, property: string, value: any): void {
  array.forEach(function (result: any, index: number) {
